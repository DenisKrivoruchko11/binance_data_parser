...
### Анализ:
В результате можно сделать вывод, что Binance отдает данные в websocket практически без задержек. Возможно, это связано с низкой нагрузкой, так как замеры проводились в вечернее время, когда торги закрыты. Хотя 5 подключение 21 раз было более оперативным, на выборке из более 6000 обновлений это не играет никакой роли.
